...
return array(
    'number.decimals_separator' => 'rakam.ondalik_ayirici',
    'number.thousands_separator' => 'rakam.bin_hane_ayirici',
    'None' => 'Hiçbiri',
    'edit' => 'düzenle',
    'Edit' => 'Düzenle',
    'remove' => 'sil',
    ...
    'RSD - Serbian dinar' => 'RSD - Sırbistan dinarı',
    ...
    'Showing %d-%d of %d' => 'Gösterilenler : %d-%d arası - toplam; %d adet',
    'Outgoing Emails' => 'Giden E-postalar',
    'Add or change currency rate' => 'Kur Oranını ekle veya değiştir',
    'Reference currency: %s' => 'Referans Para birimi: %s',
    'Add custom filters' => 'Özel filtreler ekle',
    'Export' => 'Dışa Aktar',
    ...
    'Import tasks' => 'Görevleri içe aktar',
    'Choose a project' => 'Bir proje seçin',
    'Profile' => 'Profil',
    ...
    'Kanboard Invitation' => 'KanBoard Davetiyesi',
    'Visible on dashboard' => 'Panoda görünür',
    'Created at:' => 'Oluşturulma :',
    'Updated at:' => 'Güncelleme :',
    'There is no custom filter.' => 'Özel filtre yok.',
    'New User' => 'Yeni Kullanıcı',
    'Authentication' => 'Kimlik Doğrulama',
    'If checked, this user will use a third-party system for authentication.' => 'İşaretlenirse, bu kullanıcı kimlik doğrulama için üçüncü taraf bir sistem kullanacaktır.',
    'The password is necessary only for local users.' => 'Parola yalnızca yerel kullanıcılar için gereklidir.',
    'You have been invited to register on Kanboard.' => 'Kanboard a kayıt yaptırmaya davet edildiniz.',
    'Click here to join your team' => 'Takımınıza katılmak için buraya tıklayın',
    'Invite people' => 'İnsanları davet et',
    'Emails' => 'E-postalar',
    'Enter one email address by line.' => 'Satır bazında bir e-posta adresi girin',
    'Add these people to this project' => 'Bu kişileri bu projeye ekle',
    'Add this person to this project' => 'Bu kişiyi bu projeye ekle',
    'Sign-up' => 'Kayıt',
    'Credentials' => 'Kimlik bilgileri',
    'New user' => 'Yeni kullanıcı',
    'This username is already taken' => 'Bu kullanıcı adı zaten alındı',
// eklendi - add
...
//
    'Only people with this email address will be allowed to sign up.' => 'Yalnızca bu e-posta adresine sahip kişilerin kaydolmasına izin verilir.',
    'Custom Stylesheet' => 'Özel Stil-CSS Sayfası',
    'Email domain restriction for sign up' => 'Kayıt için e-posta alan adı kısıtlaması',
    'Use a comma to enter multiple domains: domain1.tld, domain2.tld' => 'Birden fazla alan girmek için virgül kullanın. Örnek: domain1.tld, domain2.tld gibi',
    'Allow Account Creation' => 'Hesap Oluşturmaya İzin Ver',
    'Allow account creation only for those domains' => 'Hesap oluşturma işlemini yalnızca bu alanlar için izin ver',
// Google OAuth
    'Google OAuth callback URL' => 'Google OAuth geridönüş URL - Google OAuth callback URL',
    'Google Client Id' => 'Google Kullanıcı ID - Google Client Id',
    'Google Client Secret' => 'Google Kullanıcı GizliKod - Google Client Secret',
// 2 kademeli doğrulama - 2 factor aut
    'Twilio Account SID' => 'Twilio Hesap SID',
 // 'Twilio Auth Token' => 'Twilio Auth Token',
    'Twilio Phone Number' => 'Twilio Telefon Numarası',
// OAuth2   
    'OAuth2 Authentication' => 'OAuth2 Authentication - OAuth2 Doğrulama',
    'Callback URL' => 'Geri dönüş URL-si',
    'Client ID' => 'Client ID - Kullanıcı ID',
    'Client Secret' => 'Client Secret - Kullanıcı GizliKod',
    'Authorize URL' => 'Authorize URL - Yetkilendişilmiş URL',
    'Token URL' => 'Token URL-Belirtec - Token URL',
    'User API URL' => 'User API URL - Kullanıcı API URL',
    'Username Key' => 'Username Key - Kullanıcı Adı Anahtarı',
    'Name Key' => 'Name Key - İsim Anahtarı',
    'Email Key' => 'Email Key - Eposta Anahtarı',
    'User ID Key' => 'User ID Key - Kullanıcı ID Anahtarı',
// süre ölçer -  Timer
    'Board Date' => 'Pano Tarihi',
    'Billable?' => 'Fatura için süre ve tutar hesaplansın mı?',
    'Start Timer' => 'Süreyi Başlat',
    'New' => 'Yeni',
    'Start a new Timer' => 'Yeni Süre Ölçer Başlat',
    'Relation graph' => 'İlişkisel grafik',
);
